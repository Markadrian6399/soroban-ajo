      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
        ...
        <div className="bg-white p-8 rounded-xl shadow-sm border border-gray-100 flex flex-col items-start">
          ...
          <p className="text-gray-600 mb-6 flex-grow">
            Participate in decision-making processes, propose new features, and vote on protocol
            upgrades.
          </p>
          <a
            href="#"
            className="inline-flex items-center text-blue-600 font-semibold hover:text-blue-700 mt-auto"
          >
        ...
        <div className="bg-white p-8 rounded-xl shadow-sm border border-gray-100 flex flex-col items-start">
          ...
          <a
            href="#"
            className="inline-flex items-center text-indigo-600 font-semibold hover:text-indigo-700 mt-auto"
          >
